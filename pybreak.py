...
pygame.display.set_caption('Pybreak Game')
...
bg =(242, 247, 161)
#block colours
block_red = (243, 129, 129)
block_green = (104, 185, 132)
block_blue = (33, 156, 144)
#paddle colours
paddle_col = (4, 54, 74)
paddle_outline = (4, 54, 74)
#text colour
text_col = (4, 54, 74)
...
while run:
	...
	if not live_ball:
		if game_over == 0:
			draw_text('Klik Apapun untuk Memulai', font, text_col, 100, screen_height /2+100)
		elif game_over == 1:
